...
def parafac_community(N: SnapshotGraph, R: int, **tensorly_kwargs):
    """
    ...
    cp_tensor, errors = tl.decomposition.non_negative_parafac_hals(N._tensor, R, return_errors=True, **tensorly_kwargs)
